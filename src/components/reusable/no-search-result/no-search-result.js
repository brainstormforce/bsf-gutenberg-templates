...
const NoSearchResult = ( { keyword } ) => {
	return (
		<div className="flex flex-col sm:flex-row items-start justify-start gap-6 p-5 bg-background-secondary w-full h-fit rounded-lg">
			...
			<div className="space-y-1">
				<h6 className="text-heading-text text-xl font-semibold leading-7 m-0 p-0">
					Your search - { keyword } - did not match any pattern
					designs.
				</h6>
