...
const ButtonNew = (
	...
	const variantClassNames = {
		primary:
			'text-white bg-accent-spectra hover:bg-accent-hover-spectra focus-visible:ring-accent-spectra border border-solid border-accent-spectra',
		'ai-primary':
			'text-white bg-accent-st hover:bg-accent-ai-hover focus-visible:ring-accent-st border border-solid border-accent-st',
		white: 'text-accent-spectra bg-white border border-solid border-accent-spectra focus-visible:ring-accent-spectra',
		'ai-white':
			'text-accent-st bg-white border border-solid border-accent-st focus-visible:ring-accent-st',
