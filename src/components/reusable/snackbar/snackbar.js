...
const Snackbar = ( {
	...
	return (
		...
		>
			<div className="flex items-center gap-2 flex-grow max-2xl:items-start">
				<div
					className={ classNames(
						'flex items-center',
				...
				<div className="flex-1 flex justify-start items-center gap-3">
					...
					{ isClose && (
						<button
							...
							className="ml-auto bg-transparent border-0 focus:outline-none cursor-pointer p-2"
						>
			...
			{ hasVideoIntro && videoIntroURL && (
				<HowItWorks className="flex max-2xl:hidden" videoIntroURL={ videoIntroURL } />
			) }
		</div>
	);
};
