					...
					<div className="flex">
						...
						<div className="ml-2 flex-1 md:flex md:justify-between">
							<p className="text-sm text-orange-400">
								{ __( 'Your remaining AI credits are low. It might not be enough to generate the full content.', 'ast-block-templates' ) }
							</p>
							<p className="text-sm mr-2">
								<a
									...
									rel="noreferrer"
								>
									{ __( 'Buy AI Credits', 'ast-block-templates' ) }
								</a>
							</p>
						</div>
					</div>
					...
					<div className="flex">
						...
						<div className="ml-2 flex-1 md:flex md:justify-between">
							<p className="text-sm text-credit-danger">
								{ __( 'You have no AI credits left. Please purchase more credits to continue generating content.', 'ast-block-templates' ) }
							</p>
							<p className="text-sm mr-2">
								<a
									href={
