...
const ConnectOpenAI = () => {
	...
	/* 	const doItLater = async () => {
		try {
			await apiFetch( {
				path: `gutenberg-templates/v1/do-it-later`,
				method: 'GET',
				headers: {
	...
	const features = [
		...
		},
		{
			icon: (
				...
				>
					<path
						d="M19.4666 2.3999C20.6448 2.3999 21.5999 3.34194 21.5999 4.50401L21.5999 8.09583C21.5999 9.2579 20.6448 10.1999 19.4666 10.1999H16.2666C15.0884 10.1999 14.1332 9.2579 14.1332 8.09583L14.1332 4.50401C14.1332 3.34194 15.0884 2.3999 16.2666 2.3999L19.4666 2.3999Z"
						stroke="#2563EB"
						strokeWidth="2"
						strokeLinecap="round"
					...
					/>
					<path
						d="M4.53323 2.3999C3.35503 2.3999 2.3999 3.34194 2.3999 4.50401L2.39991 8.09583C2.39991 9.2579 3.35504 10.1999 4.53324 10.1999H7.73324C8.91145 10.1999 9.86658 9.2579 9.86658 8.09583L9.86657 4.50401C9.86657 3.34194 8.91144 2.3999 7.73323 2.3999L4.53323 2.3999Z"
						stroke="#2563EB"
						strokeWidth="2"
						strokeLinecap="round"
						strokeLinejoin="round"
					/>
					<path
						d="M19.4666 13.7999C20.6448 13.7999 21.5999 14.742 21.5999 15.9041V19.4958C21.5999 20.6579 20.6448 21.5999 19.4666 21.5999H16.2666C15.0884 21.5999 14.1332 20.6579 14.1332 19.4958L14.1332 15.9041C14.1332 14.742 15.0884 13.7999 16.2666 13.7999H19.4666Z"
						stroke="#2563EB"
						strokeWidth="2"
						strokeLinecap="round"
						strokeLinejoin="round"
					/>
					<path
						d="M4.53324 13.7999C3.35504 13.7999 2.39991 14.742 2.39991 15.9041L2.39991 19.4958C2.39991 20.6579 3.35504 21.5999 4.53325 21.5999H7.73325C8.91145 21.5999 9.86658 20.6579 9.86658 19.4958L9.86657 15.9041C9.86657 14.742 8.91145 13.7999 7.73324 13.7999H4.53324Z"
						stroke="#2563EB"
						strokeWidth="2"
						strokeLinecap="round"
						strokeLinejoin="round"
		...
		},
		{
			...
			description:
				"Got questions? Our AI has the answers. Whether it's troubleshooting or customizing your site, we got your back.",
		},
		{
			icon: (
				<svg
				...
				>
					<path
						d="M2 3.97434C2 2.88394 2.89543 2 4 2H20C21.1046 2 22 2.88394 22 3.97434V20.0257C22 21.1161 21.1046 22 20 22H4C2.89543 22 2 21.1161 2 20.0257V3.97434Z"
						stroke="#2563EB"
						strokeWidth="1.7"
					/>
					<path
						d="M4.35748 5.44157C4.35748 4.89637 4.8052 4.4544 5.35748 4.4544H18.6426C19.1949 4.4544 19.6426 4.89637 19.6426 5.44157V7.94377C19.6426 8.48897 19.1949 8.93094 18.6426 8.93094H5.35748C4.8052 8.93094 4.35748 8.48897 4.35748 7.94377V5.44157Z"
						stroke="#2563EB"
						strokeWidth="1.7"
					/>
					<path
						d="M8.29303 11.1402C8.84531 11.1402 9.29303 11.5822 9.29303 12.1274L9.29303 18.7411C9.29303 19.2863 8.84531 19.7283 8.29303 19.7283H5.35742C4.80514 19.7283 4.35742 19.2863 4.35742 18.7411L4.35742 12.1274C4.35742 11.5822 4.80514 11.1402 5.35742 11.1402H8.29303Z"
						stroke="#2563EB"
						strokeWidth="1.7"
					/>
					<path
						d="M18.6426 11.1402C19.1949 11.1402 19.6426 11.5822 19.6426 12.1274V18.7411C19.6426 19.2863 19.1949 19.7283 18.6426 19.7283H12.3755C11.8233 19.7283 11.3755 19.2863 11.3755 18.7411V12.1274C11.3755 11.5822 11.8233 11.1402 12.3755 11.1402H18.6426Z"
						stroke="#2563EB"
						strokeWidth="1.7"
					/>
				</svg>
		...
		},
		{
			icon: (
				...
				>
					<path
						d="M9.5999 14.9999L6.5999 11.9999L9.5999 8.9999M14.3999 8.9999L17.3999 11.9999L14.3999 14.9999M4.7999 21.5999C3.47442 21.5999 2.3999 20.5254 2.3999 19.1999V4.7999C2.3999 3.47442 3.47442 2.3999 4.7999 2.3999H19.1999C20.5254 2.3999 21.5999 3.47442 21.5999 4.7999V19.1999C21.5999 20.5254 20.5254 21.5999 19.1999 21.5999H4.7999Z"
						stroke="#2563EB"
						strokeWidth="2"
						strokeLinecap="round"
						strokeLinejoin="round"
			...
			description:
				'No more struggling with complex coding issues. Our AI can generate custom code, functions, and CSS tailored to your needs.',
		},
		{
			icon: (
				<svg
				...
				>
					<path
						d="M2.9999 7.7999H20.9999M17.9999 11.9999H5.9999M13.1999 16.7999H5.9999M5.9999 21.5999H17.9999C19.9881 21.5999 21.5999 19.9881 21.5999 17.9999V5.9999C21.5999 4.01168 19.9881 2.3999 17.9999 2.3999H5.9999C4.01168 2.3999 2.3999 4.01168 2.3999 5.9999V17.9999C2.3999 19.9881 4.01168 21.5999 5.9999 21.5999Z"
						stroke="#2563EB"
						strokeWidth="2"
						strokeLinecap="round"
						strokeLinejoin="round"
			...
			description:
				'With our AI by your side, you can create beautiful, 100% custom web pages without the need for any design or coding skills.',
		},
	];
	...
	return (
		<form
			className="max-w-container mx-auto flex flex-col gap-10 pb-5 pt-12 md:pb-10 md:pt-14 xl:pt-16 xl:pb-20"
		...
		>
			...
			<div className="flex flex-col items-center justify-center gap-6">
				...
				<p className="m-0 text-base font-normal">
					...
					<Button
						type="submit"
						variant="blank"
						className="font-normal underline text-accent-st p-0 inline-flex"
					>
						Connect an Account
					</Button>
				</p>
			...
			{ /* Features */ }
			<div className="border border-solid border-border-primary rounded-lg gap-8 flex flex-wrap py-11 px-10 shadow-medium bg-white">
				{ renderFeatures }
			</div>
		</form>
	);
