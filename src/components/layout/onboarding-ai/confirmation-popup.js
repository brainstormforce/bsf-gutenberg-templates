...
const ConfirmationPopup = ( {
	...
	const { remaining, patternsLibraryRate, patternsCategoryRate, isFreeUser } =
		useCredits();
	const {
		businessType,
		businessName,
			...
			return (
				<Fragment>
					<div className="space-y-2">
						...
						<p className="text-body-text text-base font-normal m-0">
							{ sprintf(
								/* translators: %1s: remaining credits, %2s: patterns Library Rate */
								__(
									"Your account has %1$s AI credits left. If you want to personalize the entire design library with content and images tailored to your business and website project, you'll require %2$s credits.",
									'ast-block-templates'
								),
								remaining,
								patternsLibraryRate
			...
			return (
				<Fragment>
					<div className="space-y-7 p-4 lg:p-8 bg-background-tertiary rounded-lg">
						<div className="space-y-3">
							...
							<p className="text-body-text m-0 text-sm font-normal">
								With AI credits, you have the power to
								personalize the design library with unique copy
								and beautiful images specific to your website.
							</p>
							<p className="text-body-text m-0 text-sm font-normal">
								Your free account includes 1000 AI credits. If
								you want to personalize the entire design
								library with content and images tailored to your
								business and website project, you'll require{ ' ' }
								{ patternsLibraryRate } credits.
							</p>
						</div>
						<Button
							className="w-full min-h-[45px]"
						...
						>
							{ __(
								'Unlock 200,000 AI Credits for Just $39',
								'ast-block-templates'
							) }
						</Button>
					</div>
					...
					<div className="!-mb-2 !mt-0 px-4 lg:px-8 pt-4 lg:pt-8 pb-2 space-y-7">
						<div className="space-y-3">
							<h6 className="text-xl font-bold leading-7">
								{ __(
							...
							<p className="text-body-text m-0 text-sm font-normal">
								{ sprintf(
									...
									__(
										'Begin with the 1000 AI credits provided when you signed up for your free account. With this, you can personalize templates in the %s categories.',
										'ast-block-templates'
									),
									freeCategories
								) }
							...
							<p className="text-body-text m-0 text-sm font-normal">
								{ __(
									'You can easily purchase additional AI credits later anytime.',
									'ast-block-templates'
								) }
							</p>
						</div>
			...
			<Fragment>
				<div className="space-y-2">
					...
					<p className="text-body-text">
						This will personalize the entire design library, and it
						will consume{ ' ' }
						{ ! isFreeUser
							? patternsLibraryRate
							: patternsCategoryRate * 2 }{ ' ' }
